package com.dubboclub.dk.bootstrap;
 ...
 * 启动类
 */
public class EmbedTomcatDKWebServer {

    private static final Logger log = LoggerFactory.getLogger(EmbedTomcatDKWebServer.class);
    ...
    private static String getAbsolutePath() {
        String path = null;
        String folderPath = EmbedTomcatDKWebServer.class.getProtectionDomain().getCodeSource().getLocation()
            .getPath();
